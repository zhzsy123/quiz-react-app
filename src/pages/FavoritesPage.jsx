      ...
      <div className="container dashboard-page">
        <section className="dashboard-hero left-hero compact-page-hero">
          <div className="section-header-row no-margin">
            ...
            <div className="dashboard-action-row">
              ...
              <button className="primary-btn small-btn" onClick={handleStartPractice} disabled={!canStartPractice}><Play size={14} /> 开始练习</button>
            </div>
          </div>
        </section>
        ...
        <section className="profile-card compact-card">
          <div className="section-header-row">
            ...
            <span className="section-header-tip">{filteredEntries.length} 条</span>
          </div>
        ...
        <section className="record-list-card">
          ...
          {filteredEntries.length === 0 ? (
            <div className="local-library-empty">暂无收藏内容。</div>
          ) : (
