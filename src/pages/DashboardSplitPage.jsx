  ...
  return (
    <section className="record-list-card">
      ...
      <div className="recent-attempt-list">
        <article className="recent-attempt-item">
          <div className="recent-attempt-title">
            <WandSparkles size={16} />
            推荐工作流
          </div>
          <div className="recent-attempt-meta">
            <span>1. 准备 PDF / DOCX 原始试卷</span>
            <span>2. 把试卷和 JSON Schema v2 一起发给 AI</span>
            <span>3. 让 AI 仅输出合法 JSON</span>
            <span>4. 在本站导入 JSON 开始练习或考试</span>
          </div>
        </article>
        ...
        <article className="recent-attempt-item">
          ...
          <div className="recent-attempt-meta">
            <span>单选、多选、判断、填空</span>
            <span>阅读、材料题、翻译、简答、作文</span>
            <span>图片题通过 assets 字段附加到任意题型</span>
            <span>当前第一阶段先落规范与示例，后续逐步补前端支持</span>
          </div>
        </article>
      </div>
    </section>
          ...
          <section className="rail-card spotlight-rail">
            ...
            <div className="module-card-stack compact-stack">
              ...
              <Link className="module-link-card active favorite-spotlight-card" to="/favorites">
                <div className="module-link-card-top">
                  <span className="module-link-name">
                    <Star size={15} />
                    收藏夹
                  </span>
                  <span className="module-badge">常用</span>
                </div>
                <div className="module-link-meta">
                  <span>当前收藏 {favoriteCount}</span>
                  <span>立即进入</span>
                </div>
              </Link>
            </div>
          ...
          <section className="dashboard-board-hero compact-board-hero">
            <div className="dashboard-board-head compact-board-head">
              ...
              <div className="dashboard-board-links">
                ...
                <Link className="secondary-btn small-btn" to="/favorites">
                  收藏夹
                </Link>
              </div>
            </div>
            ...
            <div className="dashboard-overview-grid dense-overview-grid">
              ...
              <div className="overview-tile">
                <span className="overview-label">总刷题量</span>
                <strong>{dashboardState.totalQuestionVolume}</strong>
              </div>
              <div className="overview-tile">
                <span className="overview-label">平均率</span>
                <strong>{overallAverageRate}%</strong>
              </div>
            </div>
          </section>
          ...
          <section className="dashboard-bottom-grid">
            <section className="trend-card">
              <div className="section-header-row">
                <h2>
                  <BarChart3 size={18} />
                  {primarySummary?.shortLabel || '英语'}历史平均分趋势
                </h2>
